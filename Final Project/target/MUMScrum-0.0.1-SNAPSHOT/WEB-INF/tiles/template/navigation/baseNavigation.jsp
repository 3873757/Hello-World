...
<li><a href="<spring:url value="/ReleaseBacklogs/"/>"><spring:message code="product.backlogs.menu"></spring:message></a></li>
<li><a href="<spring:url value="/welcome2/"/>"><spring:message code="welcome2"></spring:message></a></li>-->
